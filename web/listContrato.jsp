										...
										<h4 class="mhs_title" style="font-size: 25px;">Listado de Contratos</h4>	
											<%
												ArrayList<EnvioVO> Listado = new ArrayList<EnvioVO>();
                                                                                            ...
                                                                                            if(SbDAO.ListContratoAcarreador(id)!= null){
                                                                                            Listado = SbDAO.ListContratoAcarreador(id);
											...
											%>
												<div class="press_item mt-30">
													...
													<h4>Contrato del envio identificado con el id (<%= veh.getEnvioID()%>)</h4>
													<p class="blog_des">
														...
														precio de $<%= veh.getCosto_Final()%>
                                                                                                        ...
                                                                                                        <% if(veh.getEstado().equals("Espera")){%>
                                                                                                            <button class="Get_btn" style="position: relative; left: 88%;" onclick="window.location.href = 'cambiarEstado.jsp?EnID=<%= veh.getEnvioID()%>';">Realizar</button>
                                                                                                        <%}%>
