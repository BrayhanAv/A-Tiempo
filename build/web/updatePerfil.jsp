                ...
                <div class="container-fluid">			
                    ...
                    <div class="col-md-10" id="contenedor_form">
                        ...
                        <form class="contact100-form validate-form" action="Usuario" method="POST" onsubmit="return validacion()">
                            ...
                            <div style="color: red">
                              ...
                              <%}%>
                                    ...
                                    <%
                                        ...
                                        usVo = usDAO.search(request.getParameter("USID"));
                            ...
                            <input type="hidden" name="UsuarioID" value="<%= request.getParameter("USID") %>">
                            <input type="hidden" name="Tabla" value="acarreador">
